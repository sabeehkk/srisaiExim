    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/92 backdrop-blur-sm border-b border-gray-100 shadow-xl font-poppins">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-8">
          ...
          {/* MODIFIED: Changed alignment for centering */}
          <div className="flex items-center justify-start h-20"> 
            ...
            {/* Desktop Menu Wrapper - Uses flex-grow to take available space and justify-center to center the menu block */}
            ...
            {/* CTA Button - Pushed to the right using ml-auto */}
            ...
            {/* Mobile Menu Toggle - Stays on the far right on mobile */}
            <button
              className="md:hidden text-gray-600 hover:text-primary p-2 focus:outline-none focus-ring-visible transition duration-300 ml-auto"
